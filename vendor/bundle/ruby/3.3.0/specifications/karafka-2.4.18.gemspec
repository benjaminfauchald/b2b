...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<karafka-core>.freeze, [">= 2.4.4".freeze, "< 2.5.0".freeze])
  s.add_runtime_dependency(%q<karafka-rdkafka>.freeze, [">= 0.17.2".freeze])
  s.add_runtime_dependency(%q<waterdrop>.freeze, [">= 2.7.3".freeze, "< 3.0.0".freeze])
